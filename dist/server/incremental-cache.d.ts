...
export declare class IncrementalCache {
    ...
    get(pathname: string, url: string): Promise<IncrementalCacheEntry | null>;
    set(pathname: string, url: string, data: IncrementalCacheValue | null, revalidateSeconds?: number | false): Promise<void>;
}
export {};
